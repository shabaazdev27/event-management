  ...
  return (
    <div className="bg-neutral-900/50 border border-white/5 rounded-2xl p-6 backdrop-blur-sm">
      <div className="flex items-center gap-2 mb-4 text-indigo-400">
        ...
        {!catalogHydrated && (
          <span className="text-xs text-neutral-500 ml-auto">Syncing…</span>
        )}
      </div>
      ...
      >
        ...
        >
          ...
          {saving ? "Saving…" : "Add or update venue"}
        </button>
      </form>
        ...
        {sorted.map((v) => (
          ...
          >
            ...
            <button
              ...
              className="p-2 rounded-lg text-rose-400 hover:bg-rose-500/10 flex-shrink-0"
