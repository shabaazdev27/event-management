    ...
    <div className="min-h-screen bg-neutral-950 text-white selection:bg-indigo-500/30">
        ...
        <div className="w-full max-w-screen-2xl mx-auto px-3 sm:px-5 md:px-6 py-3 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center justify-between gap-3 min-w-0 lg:justify-start">
            <Link
              ...
              title="All venues"
            >
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center flex-shrink-0 p-1.5">
                <Image
                  src="/logo.svg"
                  alt=""
                  width={20}
            ...
            <span className="lg:hidden text-[10px] uppercase tracking-wider font-semibold text-emerald-400/90 border border-emerald-500/30 rounded-full px-2 py-0.5 flex-shrink-0">
              Guest
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-2 sm:gap-3 min-w-0">
            ...
            <nav className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3 flex-shrink-0">
      ...
      >
        ...
        <div className="lg:col-span-7 xl:col-span-8 space-y-5 sm:space-y-6 flex flex-col min-w-0 w-full min-h-0">
          <section className="bg-neutral-900/50 border border-white/5 rounded-2xl p-1 overflow-hidden flex-shrink-0 relative min-h-[280px] sm:min-h-[380px] lg:min-h-[420px]">
            <Map />
            <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 bg-black/60 backdrop-blur-md border border-white/10 rounded-xl p-3 flex flex-col sm:flex-row justify-between items-center gap-3">
              ...
              <div className="flex items-center gap-2 px-3 py-1 bg-emerald-500/20 rounded-full border border-emerald-500/30 flex-shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 flex-grow min-w-0">
            <div className="flex flex-col gap-5 sm:gap-6 min-w-0">
              <FanGame />
              <EventSchedule />
            </div>
            <section className="flex-grow flex flex-col bg-neutral-900/50 border border-white/5 rounded-2xl p-3 sm:p-4 min-h-[min(420px,70vh)] md:min-h-[400px]">
              <Chatbot />
            </section>
          </div>
        </div>
